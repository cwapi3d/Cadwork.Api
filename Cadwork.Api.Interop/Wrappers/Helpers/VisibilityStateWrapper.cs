...
public class VisibilityStateWrapper
{
  public readonly IntPtr NativePtr;

  private readonly Dictionary<Type, Delegate> _functionDelegates;

  public VisibilityStateWrapper(IntPtr nativePtr)
  {
    NativePtr = nativePtr;
    var vTable = Marshal.PtrToStructure<VisibilityStateInterfaceVTable>(Marshal.ReadIntPtr(nativePtr));
  ...
  private sealed class VisibilityStateInterfaceVTable
  {
